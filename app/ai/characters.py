"""
St. Augustine TimeQuest — AI Historian Character Definitions

Each character has era-locked knowledge and a distinct voice.
System prompts instruct the LLM how to stay in character and handle
questions outside the character's historical scope.
"""
...
def get_character(character_id: str) -> CharacterConfig | None:
